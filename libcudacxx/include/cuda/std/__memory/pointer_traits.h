...
inline constexpr bool __can_deduce_element_type = is_pointer_v<_Pointer>;

template <class _Pointer>
inline constexpr bool
  __can_deduce_element_type<_Pointer, void_t<typename __pointer_traits_element_type<_Pointer>::type>> = true;
